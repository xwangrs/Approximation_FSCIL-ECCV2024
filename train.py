...
def get_command_line_parser():
    ...
    parser.add_argument('-arch', type=str, default='timm_vit_base_patch16_224')
    ...
    parser.add_argument('-epochs_new', type=int, default=1000)
    ...
    parser.add_argument('-milestones', nargs='+', type=int, default=[30, 70, 150,300])
    # parser.add_argument('-warm_up_epochs', nargs='+', type=int, default=5)
