...
class FSCILTrainer(Trainer):
    ...
    def get_optimizer_base(self):
        ...
        if self.args.schedule == 'Step':
            ...
            scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=self.args.epochs_base)
    ...
    def train(self):
        ...
        test_tensor = torch.rand(1, 3, img_size, img_size).cuda()
        flops = FlopCountAnalysis(self.model, test_tensor)
        ...
        for session in range(args.start_session, args.sessions):
            ...
            if session == 0:  # load base class train img label
                ...
                for epoch in range(args.epochs_base):
                    ...
                    # print(self.model.module.encoder.tokenizer.masks[0])
