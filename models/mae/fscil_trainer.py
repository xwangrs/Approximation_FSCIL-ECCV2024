...
class FSCILTrainer(Trainer):
    ...
    def get_optimizer_base(self):
        ...
        param_groups = optim_factory.add_weight_decay(self.model, weight_decay=0.05)
        optimizer = torch.optim.AdamW(param_groups, self.args.lr_base, betas=(0.9, 0.95))
        print(optimizer)
    ...
    def set_save_path(self):
        ...
        self.args.save_path = self.args.save_path + '%s-start_%d/' % (mode, self.args.start_session) + self.args.flag
        if 'cos' in mode:
