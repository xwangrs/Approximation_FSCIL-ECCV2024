...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=84, patch_size=4, in_chans=3, num_classes=0,
...
@register_model
def swin_tiny(window_size=16, **kwargs):
    model = SwinTransformer(
        window_size=window_size, embed_dim=96, depths=[1, 1, 2, 1], num_heads=[3, 6, 12, 24],
        mlp_ratio=4, qkv_bias=True, drop_path_rate=kwargs.pop('drop_path_rate', 0.1),attn_drop_rate=0.3, **kwargs)
    return model
