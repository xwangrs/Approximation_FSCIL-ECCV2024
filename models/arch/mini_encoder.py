...
class ResNet(nn.Module):
    ...
    def __init__(self, block, n_blocks, keep_prob=1.0, avg_pool=False, drop_rate=0.0,
                 dropblock_size=5, num_classes=-1, use_se=False, mul=False):
        ...
        #     self.classifier = nn.Linear(640, self.num_classes*self.num_center, bias=False)
    ...
    def forward(self, x, is_feat=False, mul=False):
...
def resnet_mini(keep_prob=1.0, avg_pool=False, **kwargs):
